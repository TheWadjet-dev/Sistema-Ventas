...
<div class="container-fluid">
	...
	<div class="row">
		...
		<a class="col-xl-3 col-md-6 mb-4" href="lista_empleados.php">
		...
		<a class="col-xl-3 col-md-6 mb-4" href="GR_Pedidos.php" target="blank">
			<div class="card border-left-info shadow h-100 py-2 bg-white">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1">Reporte Ventas</div>
						</div>
						<div class="col-auto">
							<i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
						</div>
		...
		<a class="col-xl-3 col-md-6 mb-4" href="GR_Compras.php" target="blank">
			<div class="card border-left-info shadow h-100 py-2 bg-white">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1">Reporte Compras</div>
						</div>
						<div class="col-auto">
							<i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
						</div>

...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['proveedor']) || empty($_POST['RUC']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO proveedor(proveedor,RUC,telefono,direccion,usuario_id) values ('$proveedor', '$RUC', '$telefono', '$Direccion','$usuario_id')");
            if ($query_insert) {
            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese el RUC" name="RUC" id="RUC" class="form-control">
                    </div>
                    <div class="form-group">

        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label>Nombre y Apellido: <strong><?php echo $_SESSION['nombre']; ?></strong></label>
                </div>
                <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
                        ...
                        <div class="form-group">
                            <label>IVA (%):</label>
                            <input type="text" name="txtIVA" class="form-control" value="<?php echo $IVA; ?>" id="txtIVA" placeholder="IVA de la Empresa" required>
                        </div>
